...
current_data |>
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_bw() +
  labs(title = "Observed K Cross - Permuted K Cross for Tumor cell interactions",
       x = 'Cell Interaction',
       y = 'Difference',
       fill = 'Cluster')
...
current_data |>
  ...
  coord_flip() +
  theme_bw() +
  labs(title = "Observed K Cross - Permuted K Cross for Cytotoxic T cell interactions",
       x = 'Cell Interaction',
       y = 'Difference',
       fill = 'Cluster') +
  theme(plot.title = element_text(hjust = 0.5)) 
