...
km_fit <- survfit(Surv(survival_days, survival_status) ~ cluster_id_2, data = current_data)
ggsurvplot(km_fit, data = current_data)
survdiff(Surv(survival_days, survival_status) ~ cluster_id_2, data= current_data, rho = 1)
```
