...
km_fit_rec <- survfit(Surv(recurrence_days, recurrence) ~ cluster_id_4, data = recurrence_data)
ggsurv <- ggsurvplot(km_fit_rec, data = recurrence_data, xlim = c(0,8500), 
...
survdiff(Surv(recurrence_days, recurrence) ~ cluster_id_4, data = recurrence_data, rho = 1)
...
current_data |>
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  theme_bw() +
  labs(title = "Observed K Cross - Permuted K Cross for CK cell interactions",
       x = 'Cell Interaction',
       y = 'Difference',
       fill = 'Cluster')
...
current_data |>
  ...
  coord_flip() +
  theme_bw() +
  labs(title = "Observed K Cross - Permuted K Cross for CD8 cell interactions",
       x = 'Cell Interaction',
       y = 'Difference',
       fill = 'Cluster') +
  theme(plot.title = element_text(hjust = 0.5)) 
